...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\kind_mulja\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\kind_mulja\hook\ament_prefix_path.bat"
