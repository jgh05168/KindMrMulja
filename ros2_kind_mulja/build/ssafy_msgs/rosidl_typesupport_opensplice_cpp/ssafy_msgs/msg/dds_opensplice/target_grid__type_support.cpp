...
#include "ssafy_msgs/msg/target_grid__rosidl_typesupport_opensplice_cpp.hpp"
...
using __dds_msg_type_TargetGrid = ssafy_msgs::msg::dds_::TargetGrid_;
using __ros_msg_type_TargetGrid = ssafy_msgs::msg::TargetGrid;

static ssafy_msgs::msg::dds_::TargetGrid_TypeSupport __type_support_TargetGrid;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_ssafy_msgs
const char *
register_type__TargetGrid(
  ...
  const char * type_name)
{
  ...
  DDS::ReturnCode_t status = __type_support_TargetGrid.register_type(participant, type_name);
  switch (status) {
...
convert_ros_message_to_dds(
  const __ros_msg_type_TargetGrid & ros_message,
  __dds_msg_type_TargetGrid & dds_message)
{
  ...
  const void * untyped_ros_message)
{
  ...
  const __ros_msg_type_TargetGrid & ros_message = *static_cast<const __ros_msg_type_TargetGrid *>(untyped_ros_message);
  __dds_msg_type_TargetGrid dds_message;
...
convert_dds_message_to_ros(
  const __dds_msg_type_TargetGrid & dds_message,
  __ros_msg_type_TargetGrid & ros_message)
{
  // member.name product_x
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    __ros_msg_type_TargetGrid & ros_message = *static_cast<__ros_msg_type_TargetGrid *>(untyped_ros_message);
  ...
  void * untyped_serialized_data)
{
  ...
  DDS::OpenSplice::CdrTypeSupport cdr_ts(__type_support_TargetGrid);
...
static message_type_support_callbacks_t TargetGrid_callbacks = {
  "ssafy_msgs::msg",
  "TargetGrid",
  &register_type__TargetGrid,
  &publish__TargetGrid,
...
static rosidl_message_type_support_t TargetGrid_handle = {
  rosidl_typesupport_opensplice_cpp::typesupport_identifier,
  &TargetGrid_callbacks,
...
{
  return &ssafy_msgs::msg::typesupport_opensplice_cpp::TargetGrid_handle;
}
