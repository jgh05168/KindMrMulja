...
#include "ssafy_msgs/msg/work_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ssafy_msgs
max_serialized_size_WorkStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const ssafy_msgs::msg::WorkStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ssafy_msgs::msg::WorkStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WorkStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ssafy_msgs::msg::WorkStatus *>(
...
{
  return max_serialized_size_WorkStatus(full_bounded, 0);
}
...
{
  return &ssafy_msgs::msg::typesupport_fastrtps_cpp::_WorkStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ssafy_msgs, msg, WorkStatus)() {
  return &ssafy_msgs::msg::typesupport_fastrtps_cpp::_WorkStatus__handle;
}
