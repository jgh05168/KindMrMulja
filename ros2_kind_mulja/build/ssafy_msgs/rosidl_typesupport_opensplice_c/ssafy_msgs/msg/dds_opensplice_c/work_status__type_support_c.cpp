...
#include "ssafy_msgs/msg/work_status__rosidl_typesupport_opensplice_c.h"
...
#include "ssafy_msgs/msg/work_status.h"
...
using __dds_msg_type_ssafy_msgs__msg__WorkStatus = ssafy_msgs::msg::dds_::WorkStatus_;
using __ros_msg_type_ssafy_msgs__msg__WorkStatus = ssafy_msgs__msg__WorkStatus;

static ssafy_msgs::msg::dds_::WorkStatus_TypeSupport _type_support_ssafy_msgs__msg__WorkStatus;

static const char *
register_type_ssafy_msgs__msg__WorkStatus(void * untyped_participant, const char * type_name)
{
  ...
  DDS::ReturnCode_t status = _type_support_ssafy_msgs__msg__WorkStatus.register_type(participant, type_name);
  switch (status) {
...
static const char *
convert_ros_to_dds_ssafy_msgs__msg__WorkStatus(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const __ros_msg_type_ssafy_msgs__msg__WorkStatus * ros_message = static_cast<const __ros_msg_type_ssafy_msgs__msg__WorkStatus *>(untyped_ros_message);
  __dds_msg_type_ssafy_msgs__msg__WorkStatus * dds_message = static_cast<__dds_msg_type_ssafy_msgs__msg__WorkStatus *>(untyped_dds_message);
  // Field name: is_done
  {
...
static const char *
publish_ssafy_msgs__msg__WorkStatus(void * dds_data_writer, const void * ros_message)
{
  if (!dds_data_writer) {
  ...
  __dds_msg_type_ssafy_msgs__msg__WorkStatus dds_message;
  const char * err_msg = convert_ros_to_dds_ssafy_msgs__msg__WorkStatus(ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }
...
static const char *
convert_dds_to_ros_ssafy_msgs__msg__WorkStatus(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    return "ros message handle is null";
  }
  ...
  const __dds_msg_type_ssafy_msgs__msg__WorkStatus * dds_message = static_cast<const __dds_msg_type_ssafy_msgs__msg__WorkStatus *>(untyped_dds_message);
  __ros_msg_type_ssafy_msgs__msg__WorkStatus * ros_message = static_cast<__ros_msg_type_ssafy_msgs__msg__WorkStatus *>(untyped_ros_message);
  // Field name: is_done
  {
    ros_message->is_done = (dds_message->is_done_ != 0);
  }

  // Field name: is_start
  {
    ros_message->is_start = (dds_message->is_start_ != 0);
  }
...
static const char *
take_ssafy_msgs__msg__WorkStatus(
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    errs = convert_dds_to_ros_ssafy_msgs__msg__WorkStatus(&dds_messages[0], untyped_ros_message);
    if (errs != 0) {
      goto finally;
    }
    *taken = true;
...
static const char *
serialize_ssafy_msgs__msg__WorkStatus(
  ...
  void * untyped_serialized_data)
{
  ...
  __dds_msg_type_ssafy_msgs__msg__WorkStatus dds_message;
  const char * err_msg = convert_ros_to_dds_ssafy_msgs__msg__WorkStatus(untyped_ros_message, &dds_message);
  if (err_msg != 0) {
    return err_msg;
  }

  DDS::OpenSplice::CdrTypeSupport cdr_ts(_type_support_ssafy_msgs__msg__WorkStatus);
...
static const char *
deserialize_ssafy_msgs__msg__WorkStatus(
  ...
  void * untyped_ros_message)
{
  ...
  errs = convert_dds_to_ros_ssafy_msgs__msg__WorkStatus(&dds_message, untyped_ros_message);

  return errs;
}


static message_type_support_callbacks_t WorkStatus__callbacks = {
  "ssafy_msgs::msg",  // message_namespace
  "WorkStatus",  // message_name
  register_type_ssafy_msgs__msg__WorkStatus,  // register_type
  publish_ssafy_msgs__msg__WorkStatus,  // publish
  take_ssafy_msgs__msg__WorkStatus,  // take
  serialize_ssafy_msgs__msg__WorkStatus,  // serialize message
  deserialize_ssafy_msgs__msg__WorkStatus,  // deserialize message
  convert_ros_to_dds_ssafy_msgs__msg__WorkStatus,  // convert_ros_to_dds
  convert_dds_to_ros_ssafy_msgs__msg__WorkStatus,  // convert_dds_to_ros
};

static rosidl_message_type_support_t WorkStatus__type_support = {
  rosidl_typesupport_opensplice_c__identifier,
  &WorkStatus__callbacks,  // data
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  WorkStatus)()
{
  return &WorkStatus__type_support;
}
